...
export const mockPeople: Person[] = [
  ...
  },
  {
    ...
    moves: [
      { id: 'm-2a', personId: 'p-2', fromRoles: [], toRoles: ['donor'], date: '2024-02-20', trigger: 'First donation — $5,000 to Capital Campaign (via Chen Technologies)' },
    ],
  ...
  },
  {
    ...
    roles: ['volunteer'],
    organizationId: 'org-2', organizationName: 'Springfield Community Bank',
    moves: [
...
export const mockOrganizations: Organization[] = [
  {
    id: 'org-1', name: 'Chen Technologies', type: 'corporation',
    ein: '36-1234567', contactName: 'Michael Chen', contactEmail: 'mchen@chentech.com', contactPhone: '(555) 234-5678',
    address: '100 Tech Parkway', city: 'Springfield', state: 'IL', zip: '62702',
  ...
  {
    id: 'org-2', name: 'Springfield Community Bank', type: 'corporation',
    ein: '36-9876543', contactName: 'David Park', contactEmail: 'dpark@scbank.com', contactPhone: '(555) 444-5555',
    address: '200 Main St', city: 'Springfield', state: 'IL', zip: '62701',
  ...
  {
    id: 'org-3', name: 'Paws & Claws Pet Supply', type: 'small-business',
    ein: '36-5555555', contactName: 'Karen Wright', contactEmail: 'karen@pawsclaws.com', contactPhone: '(555) 666-7777',
    address: '50 Commerce Dr', city: 'Springfield', state: 'IL', zip: '62703',
  ...
  {
    id: 'org-4', name: 'Heart of Illinois Foundation', type: 'foundation',
    ein: '36-7777777', contactName: 'Robert Hall', contactEmail: 'rhall@hoif.org', contactPhone: '(555) 888-9999',
    address: '300 Philanthropy Ln', city: 'Springfield', state: 'IL', zip: '62704',
    memberIds: [], roles: ['donor'],
...
export const mockDonations: Donation[] = [
  ...
  { id: 'd-2', personId: 'p-2', personName: 'Michael Chen', organizationId: 'org-1', organizationName: 'Chen Technologies', type: 'monetary', amount: 5000, description: 'Building renovation fund', date: '2024-10-05', category: 'Capital Campaign', receiptIssued: true },
  ...
  { id: 'd-4', personId: 'p-3', personName: 'Emily Rodriguez', organizationId: 'org-2', organizationName: 'Springfield Community Bank', type: 'time', hours: 16, description: 'Dog walking and socialization', date: '2024-10-15', category: 'Animal Care', receiptIssued: false },
  ...
  { id: 'd-6', organizationId: 'org-1', organizationName: 'Chen Technologies', type: 'monetary', amount: 7500, description: 'Corporate matching gift — year end', date: '2024-10-20', category: 'General Fund', receiptIssued: true },
  ...
  { id: 'd-9', organizationId: 'org-3', organizationName: 'Paws & Claws Pet Supply', type: 'in-kind', itemDescription: 'Pet food and toys (bulk)', estimatedValue: 1800, description: 'Quarterly supply donation', date: '2024-10-28', category: 'Supplies', receiptIssued: true },
  { id: 'd-10', organizationId: 'org-4', organizationName: 'Heart of Illinois Foundation', type: 'monetary', amount: 25000, description: 'Annual operating grant', date: '2024-07-01', category: 'General Fund', receiptIssued: true },
  { id: 'd-11', organizationId: 'org-2', organizationName: 'Springfield Community Bank', type: 'monetary', amount: 10000, description: 'Shelter renovation sponsorship', date: '2024-09-15', category: 'Capital Campaign', receiptIssued: true },
];
...
// Helper to build tax letter records from donations
