...
insert into organizations (id, tenant_id, name, type, ein, contact_name, contact_email, contact_phone, address, city, state, zip, member_ids, roles, total_donations, total_volunteer_hours, matching_gift_program, match_ratio, tags, notes, created_at, updated_at, is_active) values
  ('460abd3a-96a3-406f-a789-31c809f43f88', 'eae04d4f-c772-45f4-9a88-c34e2d590ceb', 'Chen Technologies', 'corporation', '36-1234567', 'Michael Chen', 'mchen@chentech.com', '(555) 234-5678', '100 Tech Parkway', 'Dickson', 'TN', '37055', '["p-2"]', '["donor","sponsor"]', 25000, 0, true, 1.0, '["Major Donor","Corporate Sponsor"]', null, '2024-02-15', '2024-10-20', true),
  ('f7f8ab01-91a7-43e2-b601-2ede15c29cf6', 'eae04d4f-c772-45f4-9a88-c34e2d590ceb', 'Dickson County Community Bank', 'corporation', '36-9876543', 'David Park', 'dpark@scbank.com', '(555) 444-5555', '200 Main St', 'Dickson', 'TN', '37055', '["p-3"]', '["donor","volunteer"]', 10000, 80, true, 0.5, '["Corporate Volunteer"]', null, '2024-01-05', '2024-10-15', true),
